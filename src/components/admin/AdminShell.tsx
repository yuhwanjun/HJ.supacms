...
export default function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-black text-stone-200 font-sans">
      ...
      <aside className="fixed inset-y-0 left-0 z-20 w-64 border-r border-stone-800 bg-stone-950 flex flex-col">
        ...
        <div className="flex-1 py-6 px-3 space-y-6 overflow-y-auto">
          ...
          <div>
            ...
            <nav className="space-y-1">
              <button className="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium text-stone-400 rounded-md hover:text-stone-100 hover:bg-stone-900 transition-colors">
      ...
      <div className="pl-64 min-h-screen flex flex-col bg-stone-950/50">
        <header className="h-16 border-b border-stone-800 bg-stone-950/50 backdrop-blur-sm flex items-center justify-between px-8 sticky top-0 z-10">
